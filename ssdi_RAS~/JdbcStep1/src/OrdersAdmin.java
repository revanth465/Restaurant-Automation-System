...
String add;
  ...
  public void Orders_table() throws SQLException{
       try {
String sql=" select o.order_id as 'Order Id', concat(fname,' ',lname) as 'Customer Name', o.table_id as 'Table Num',o.ostatus as 'Order Status',o.timestamp_created as 'Last Modified' from orders o,customer as c where o.cid=c.cid and o.ostatus='processing' ";
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addComponent(orderid, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(MENU)
                    .addComponent(orderid, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(delete))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
System.out.println(add);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
     ...
     String sql="delete from order_list where order_id="+add+" ";
        try{
            pst=mycon.prepareStatement(sql);
        ...
        String sql1="delete from orders where order_id= "+add+" ";
        try{
