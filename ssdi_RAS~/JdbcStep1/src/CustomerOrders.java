 ...
 * @author nbhirud
 */
public class CustomerOrders implements OrderListInterface {
    String type;
    int id;
    ResultSet rs;
    ...
    public ResultSet getOrders() {
        ...
        //if ("customer".equals(type)) {
            sql="select o.order_id as 'Order ID', o.table_id as Table_Number,  o.ostatus as Order_Status, concat(fname,' ',lname) as Customer_Name, o.total_payable as Total_Payable from customer c, orders o where c.cid = o.cid and o.ostatus = 'Processing' and c.cid = '"+id+"' ";           
        //}
