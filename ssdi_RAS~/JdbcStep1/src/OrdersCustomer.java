...
ResultSet rs=null;
  ...
  public void Orders_table() throws SQLException{
       try {
           String sql="select o.order_id, o.table_id as Table_Number,  o.ostatus as Order_Status, concat(fname,' ',lname) as Customer_Name, o.total_payable as Total_Payable from customer c, orders o where c.cid = o.cid and o.ostatus = 'Processing' and c.cid = '"+StaticDataKeeper.customer_id+"' ";
