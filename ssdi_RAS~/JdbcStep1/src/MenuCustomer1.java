  ...
  public void show7_table(){
       try {
         //  Open_table.setVisible(true);
           ...
           String sql="Select menu.menu_id as 'Menu ID',menu.mname as 'Menu Name',order_list.quantity as 'Quantity' ,menu.price as 'Price',order_list.quantity*menu.price as 'Total Price' from order_list join menu on menu.menu_id = order_list.menu_id where order_id=" +o.getOrderID();
    ...
    public void show_table(){
      ...
      public void show1_table(){
       try {
           Open_table.setVisible(true);
           Open_table.setRowHeight(30);
           String sql="Select menu_id as 'Menu ID',mname as Name,description,price from menu where mtype='entrees'";
           pst=mycon.prepareStatement(sql);
           rs=pst.executeQuery();
           Open_table.setModel(DbUtils.resultSetToTableModel(rs));
           }
       ...
       try {
           ...
           String sql="Select menu_id as 'Menu ID',mname as Name,description,price from menu where mtype='tandoori'";
           pst=mycon.prepareStatement(sql);
           rs=pst.executeQuery();
            Open_table.getColumnModel().getColumn(1).setMaxWidth(20); 
           Open_table.setModel(DbUtils.resultSetToTableModel(rs));
       ...
       try {
           Open_table.setVisible(true);
           Open_table.setRowHeight(30);
           String sql="Select menu_id as 'Menu ID',mname as Name,description,price from menu where mtype='desserts'  ";
           pst=mycon.prepareStatement(sql);
           rs=pst.executeQuery();
           Open_table.setModel(DbUtils.resultSetToTableModel(rs));
           }
       ...
       try {
           Open_table.setVisible(true);
           Open_table.setRowHeight(30);
           String sql="Select menu_id as 'Menu ID',mname as Name,description,price from menu where mtype='beer'  ";
           pst=mycon.prepareStatement(sql);
           rs=pst.executeQuery();
           Open_table.setModel(DbUtils.resultSetToTableModel(rs));
           }
       ...
       try {
           Open_table.setVisible(true);
           Open_table.setRowHeight(30);
           String sql="Select menu_id as 'Menu ID',mname as Name,description,price from menu where mtype='biryani'";
           pst=mycon.prepareStatement(sql);
           rs=pst.executeQuery();
           Open_table.setModel(DbUtils.resultSetToTableModel(rs));
           }
    ...
    private void initComponents() {
        ...
        entrees_button.setText("ENTREES");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(appetizer_button, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(95, 95, 95)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(tandoori_button, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(biryani_button, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(deserts_button, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(beer_button, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
...
public static String getStackTrace(final Throwable throwable) {
 ...
 if(clicked==0){
     ...
     JOptionPane.showMessageDialog(null,"Customer_id is "+StaticDataKeeper.customer_id);
     
     int customer_id = StaticDataKeeper.customer_id;
     /*
     ...
     */
        o = new Orders(value1, customer_id);
        o.setOrderID();
       clicked++;
 }
    ...
    private void Open_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Open_tableMouseClicked
        ...
        try{
           ...
           if(rs.next())
           {
               ...
               txt_menu_id.setText(add1);
               txt_menu_id.setEditable(false);
           }
        }catch(Exception e){
               JOptionPane.showMessageDialog(null, e);
        }
